...
import 'package:vss_book_seat/src/widgets/seat_widget.dart';
          ...
          GestureDetector(
            child: Text(
              value.first.seatGroupName == ''
                  ? 'Khác'
                  : '${value.first.seatGroupName} - ${currencyFormat.format(value.first.seatGroupFare)}',
              maxLines: 3,
  ...
  List<Widget> createRowInGroupWithoutDisplayGroup(
    ...
    return [
      GridView.count(
        ...
        children: [
          ...seatsModelGroup
              .map<SeatWidget>((seat) => SeatWidget(
                    model: SeatModel(
